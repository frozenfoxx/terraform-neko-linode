...
DAYS=${DAYS:-'365'}
FQDN=${FQDN:-"neko.churchoffoxx.net"}
...
generate_cert()
{
  ...
  openssl req -nodes \
    ...
    -subj "/C=US/ST=State/L=Town/O=Church of Foxx/OU=Neko/CN=${FQDN}"
...
usage()
{
  ...
  echo "    FQDN                fully qualified domain name of the server (default: neko.churchoffoxx.net)"
}
